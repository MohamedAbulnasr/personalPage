...
*/
			...
			#me{
				...
				background-image: -webkit-gradient( linear, left top, right top, color-stop(0, #1ae), color-stop(0.1, #22d), color-stop(0.5, #2ab),color-stop(0.7, #3b3), color-stop(1, #1a1) );
			  color:transparent;
			...
			#hd{
				background-image:url("../images/1.jpg"), url("../images/13.jpg");
		...
		<div class="container-fluid">
			<div id="bio">
				...
				<div class="img-responsive col-xs-3">
					<img id="mypic" class="img-rounded animated " src="../images/12.jpg" alt="myPic">
				</div>
				<div class="col-xs-7">
			...
			<div id="port">
				...
				<div class="col-xs-4">
					<div id="derasat1"><a href="http://derasatdomyat.com">
						<img id="mypic1" class="img-rounded animated picpro" src="../images/derasatlogoxs.png" alt="Pic of Derasat Site"></a>
					</div>
				</div>

				<div id="bara3im1" class="col-xs-4">
					<img id="mypic2" class="img-rounded animated picpro" src="../images/bara3imxs.png" alt="Pic of Bara3im Site">
				</div>
				<div class="col-xs-4">
					<div id="empty1">
						<img id="mypic3" class="img-rounded animated picpro" src="../images/empty1.png" alt="Empty Pic">
					</div>
				</div>
			</div>
			<div id="cont">
